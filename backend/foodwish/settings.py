"""
Django settings for foodwish project.
...
ALLOWED_HOSTS = ["foodwish.onrender.com", "localhost", "127.0.0.1"]
...
WSGI_APPLICATION = 'foodwish.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'foodwish-media'
